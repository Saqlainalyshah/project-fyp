...
class _JobDetailsState extends State<JobDetails> {
  ...
  getTranslatedText( String targetLanguage) async{
    print("=====>>>"+widget.jobId);
    print("=========>>>"+widget.userModelClass.toString());
    print(widget.jobModelClass);
    final translatedText = await translateText(widget.jobModelClass.description.toString(), targetLanguage, apiKey);
    setState(() {
  ...
  Widget build(BuildContext context) {
    //getCurrentUser();
    // print("oops===?"+currentUser.toString());
...
class _ApplyForJobState extends State<ApplyForJob> {
  ...
  getTranslatedText(String target) async{
    final translatedText = await translateText( _proposalCon.text.toString(),target, apiKey);
    setState(() {
      //translatedUrduText=translatedText!;
