...
List<String> buttonsList = ["About", "Work", "Message",];
...
class ViewProfile extends StatefulWidget {
  ...
  Key? key,
    ...
    required this.workerModelClass
  }) :super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child:currentIndex==0? aboutTopSection(height,width,widget.userModelClass!):
               Row(
                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                         Text(widget.workerModelClass?.workCategory??'',                          style: TextStyle(
                            fontSize: 30,
                            letterSpacing: 0.7,
                        ...
                        sizedBoxH10,
                        labelText("Joined"),
                        boldText(widget.workerModelClass?.createdAt??''),
                        sizedBoxH10,
                        labelText("Experience"),
                        boldText(widget.workerModelClass?.workExperience??''),
                      ],
                    ),
                  ),
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => CupertinoButton(
                  color: currentIndex == index ? const Color(0xff0077B5): Colors.white,
                  padding: const EdgeInsets.symmetric(horizontal: 30),
                  onPressed: () {
                    setState(() {
                      currentIndex = index;
                      //Update currentIndex here
                      controller.animateToPage(currentIndex, duration:const Duration(milliseconds:500 ),
...
Widget aboutTopSection(double height,double width,UserModelClass user,){
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceAround,
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
...
///About Section start
///
Widget bottomAboutSection(){
  return const Center(
    child: Text("Hello ! Here is about section of user"),
  );
}
