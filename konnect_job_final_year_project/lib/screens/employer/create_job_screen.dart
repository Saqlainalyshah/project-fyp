 ...
 // late Classifier _classifier;
  ...
  addJobData() async{
    ...
    if(jobTitle.toString().isNotEmpty && _descriptionCon.text.isNotEmpty &&
      ...
      FirebaseJobsServices firebaseService=FirebaseJobsServices();
      ...
      setState(() {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Please fill all required fields & then try again!'),
          ),
        );
      });
  ...
  getTranslatedText(String target) async{
    final translatedText = await translateText( _descriptionCon.text.toString(),target, apiKey);
    setState(() {
