...
class EmployerViewScreen extends StatefulWidget {
  ...
  const EmployerViewScreen({super.key,
  });
          ...
          switch (snapshot.connectionState){
            ...
            case ConnectionState.done:
              ...
              workerSkillsModelList = workerData
                  ?.map((e) => WorkerSkillsDataModelClass.fromJSON(e.data()))
                  .toList() ?? [];
              if(workerSkillsModelList.isNotEmpty){
                  ...
                  itemBuilder: (context, index) {
                    return StreamBuilder(
                      stream: FirebaseFirestore.instance.collection("Users")
                          .where("userId", isEqualTo: workerSkillsModelList[index].workerId)
                          .snapshots(),
                ...
                return Center(child: TextWidget(text: "No worker is found!", isBold: true));
              }
          }
        },
      ),
