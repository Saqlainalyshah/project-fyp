...
final languageControllerProvider = ChangeNotifierProvider((ref) => LanguageController());
void main() async {
  ...
  var currentUser = FirebaseAuth. instance. currentUser; if (currentUser != null) {
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      home: APIs.auth.currentUser!=null? StreamBuilder(
